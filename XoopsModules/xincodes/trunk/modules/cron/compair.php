<?php
	...
	$sql = 'SELECT a.id as id, b.profile_id as uid FROM '. $GLOBALS['xoopsDB']->prefix('xincodes').' a INNER JOIN '. $GLOBALS['xoopsDB']->prefix('profile_profile').' b on a.'.PROFILE_FIELD . ' = b.'.XINCODES_FIELD . ' WHERE b.active = 1';
